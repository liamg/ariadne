...
// slowlyFindRayAttacks returns a bitboard of all squares attacked by a sliding piece (bishop, rook, or queen) from the given square, considering the occupancy of the board. It uses a simple loop to find all squares in each direction until it hits an occupied square or the edge of the board.
